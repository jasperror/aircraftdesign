...
classdef airfoil % commented code? When its 2 hours until the deadline, we don't need commented code...
    properties (Constant)
        a64206_50k = cell2mat(struct2cell(load("airfoils.mat","a64206_50k"))); % Data collected from airfoiltools.com
        a64206_100k = cell2mat(struct2cell(load("airfoils.mat","a64206_100k")));
        a64206_200k = cell2mat(struct2cell(load("airfoils.mat","a64206_200k")));
        a64206_500k = cell2mat(struct2cell(load("airfoils.mat","a64206_500k")));
        a64206_1000k = cell2mat(struct2cell(load("airfoils.mat","a64206_1000k")));

        a20714_50k = cell2mat(struct2cell(load("airfoils.mat","a20714_50k")));
        a20714_100k = cell2mat(struct2cell(load("airfoils.mat","a20714_100k")));
        a20714_200k = cell2mat(struct2cell(load("airfoils.mat","a20714_200k")));
        a20714_500k = cell2mat(struct2cell(load("airfoils.mat","a20714_500k")));
        a20714_1000k = cell2mat(struct2cell(load("airfoils.mat","a20714_1000k")));
    end
    methods (Static)
        function [range, a6l, a6u, a2l, a2u, Re] = datasetup(Re)
            if Re < 50e3
                Re = 50e3;
                range = [50e3, 50.01e3];
                a6l = airfoil.a64206_50k;
                a6u = airfoil.a64206_50k;
                a2l = airfoil.a20714_50k;
                a2u = airfoil.a20714_50k;

            elseif Re < 100e3
                range = [50e3, 100e3];
                a6l = airfoil.a64206_50k;
                a6u = airfoil.a64206_100k;
                a2l = airfoil.a20714_50k;
                a2u = airfoil.a20714_100k;
                

            elseif Re < 200e3
                range = [100e3, 200e3];
                a6l = airfoil.a64206_100k;
                a6u = airfoil.a64206_200k;
                a2l = airfoil.a20714_100k;
                a2u = airfoil.a20714_200k;

            elseif Re < 500e3
                range = [200e3, 500e3];
                a6l = airfoil.a64206_200k;
                a6u = airfoil.a64206_500k;
                a2l = airfoil.a20714_200k;
                a2u = airfoil.a20714_500k;
            elseif Re < 1000e3
                range = [500e3, 1000e3];
                a6l = airfoil.a64206_500k;
                a6u = airfoil.a64206_1000k;
                a2l = airfoil.a20714_500k;
                a2u = airfoil.a20714_1000k;
            else
                range = [1000e3, 1001e3];
                a6l = airfoil.a64206_1000k;
                a6u = airfoil.a64206_1000k;
                a2l = airfoil.a20714_1000k;
                a2u = airfoil.a20714_1000k;
                Re = 1000e3;
            end
        end
        function [alpha_ZL_root, alpha_ZL_tip] = zerolift(Re)
            [range, a6l, a6u, a2l, a2u, Re] = airfoil.datasetup(Re);
            % alpha_ZL
        ...
        function [Cd_root, Cd_tip, Cl_root, Cl_tip, Cm_root, Cm_tip] = coefficients(alpha_root, alpha_tip, alpha_eff_root, alpha_eff_tip, Re)
            [range, a6l, a6u, a2l, a2u, Re] = airfoil.datasetup(Re);
            alpha_tip = rad2deg(alpha_tip);
            alpha_root = rad2deg(alpha_root);
            alpha_eff_tip = rad2deg(alpha_eff_tip);
            alpha_eff_root = rad2deg(alpha_eff_root);
            % Cl
        ...
        function [a0_root, a0_tip] = a0(Re)
            ...
            i6l = find(il6(2:end)==1,1)+2;
            i6u = find(iu6(2:end)==1,1)+1;
            i2l = find(il2(2:end)==1,1)+2;
            i2u = find(iu2(2:end)==1,1)+1;
